...
const ProductDetails = () => {
  ...
  >
    <img src={image} alt={`Thumbnail ${index + 1}`} />
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                              <img className='w-3.5 md:w-4' src={i<4 ? assets.star_icon: assets.star_dull_icon} alt="star" /> 
                            ))}
           ...
           <button onClick={()=>{navigate('/products'); scrollTo(0,0)}} className='mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/30 transition'>See More</button>
            </div>
        </div>
    );
};
